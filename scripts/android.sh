...
scons platform=android target=release android_arch=armv7  use_lto=yes $SCONS_FLAGS
echo_header "Building ARMv8 release export template for Android…"
scons platform=android target=release android_arch=arm64v8  use_lto=yes $SCONS_FLAGS
echo_header "Building x86 release export template for Android…"
scons platform=android target=release android_arch=x86  use_lto=yes $SCONS_FLAGS
echo_header "Building ARMv7 debug export template for Android…"
scons platform=android target=release_debug android_arch=armv7 use_lto=yes $SCONS_FLAGS
echo_header "Building ARMv8 debug export template for Android…"
scons platform=android target=release_debug android_arch=arm64v8 use_lto=yes $SCONS_FLAGS
echo_header "Building x86 debug export template for Android…"
scons platform=android target=release_debug android_arch=x86 use_lto=yes $SCONS_FLAGS
