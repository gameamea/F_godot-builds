...
if [ "$buildWithMono" -eq 1 ]; then
  ...
  cmdScons p=android android_arch=x86_64 target=release_debug $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
  ...
  cmdScons p=android android_arch=x86 target=release_debug $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
  if [ $? -eq 0 ]; then result=1; else result=0; fi
  if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
  ...
  cmdScons p=android android_arch=armv7 target=release_debug $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
  if [ $? -eq 0 ]; then result=1; else result=0; fi
  if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
  ...
  cmdScons p=android android_arch=arm64v8 target=release_debug $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
  if [ $? -eq 0 ]; then result=1; else result=0; fi
  if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
fi
...
cmdScons p=android android_arch=x86_64 target=release $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
if [ $? -eq 0 ]; then result=1; else result=0; fi
if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
...
cmdScons p=android android_arch=x86 target=release $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
if [ $? -eq 0 ]; then result=1; else result=0; fi
if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
...
cmdScons p=android android_arch=armv7 target=release $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
if [ $? -eq 0 ]; then result=1; else result=0; fi
if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
...
cmdScons p=android android_arch=arm64v8 target=release $LTO_FLAG $SCONS_FLAGS $MONO_OPTIONS
if [ $? -eq 0 ]; then result=1; else result=0; fi
if [ $result -eq 1 ]; then echo_success "$label built successfully"; else echo_warning "$label built with error"; fi
